        ...
        <div className="flex-1 flex gap-4 px-8 pb-8 overflow-hidden">
          <nav className="flex flex-col items-center pb-2">
            <div className="w-16 bg-moCream/80 rounded-[2rem] flex flex-col items-center py-6 gap-6 shadow-sm border border-moBlack">
              <NavLink to="/home" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="home" size={20} color="currentColor" /></NavLink>
              <NavLink to="/diary" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="diary" size={20} color="currentColor" /></NavLink>
              <NavLink to="/habit" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="sparkle" size={20} color="currentColor" /></NavLink>
              <NavLink to="/calendar" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="calendar" size={20} color="currentColor" /></NavLink> 
              {/* 確保這裡是 /analyze */}
              <NavLink to="/analyze" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="gauge" size={20} color="currentColor" /></NavLink>
              
              <NavLink to="/chat" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border-2 border-[#A1A34E] text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-[#6b7280] hover:text-moBrown"}`}><Icon name="chat" size={20} color="currentColor" /></NavLink>
            </div>
          ...
          <main className="flex-1 flex justify-center items-center py-4 overflow-y-auto">
              <div className="text-2xl font-bold font-serif text-moBrown/50 border-2 border-dashed border-moBrown/30 rounded-[2rem] p-20 bg-white/50 backdrop-blur-sm shadow-sm">
                朝弼的 Analyze Page 準備中...
              </div>
          </main>
        </div>
      </div>
