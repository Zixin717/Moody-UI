                ...
                <div className="flex-1 flex gap-4 px-8 pb-8 overflow-hidden">
                    ...
                    <nav className="flex flex-col items-center pb-2 flex-shrink-0">
                        <div className="w-16 bg-moCream rounded-[2rem] flex flex-col items-center py-6 gap-6 shadow-sm border border-moBlack">
                            ...
                            <NavLink to="/home" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="home" size={20} color="currentColor" /></NavLink>
                            <NavLink to="/diary" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="diary" size={20} color="currentColor" /></NavLink>
                            <NavLink to="/habit" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="sparkle" size={20} color="currentColor" /></NavLink>
                            <NavLink to="/calendar" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="calendar" size={20} color="currentColor" /></NavLink>
                            <NavLink to="/analyze" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="gauge" size={20} color="currentColor" /></NavLink>
                            <NavLink to="/chat" className={({ isActive }) => `w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moOlive border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-moOlive hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="chat" size={20} color="currentColor" /></NavLink>
                        </div>
                        ...
                        {/* 2-2 禮物牆 */}
                        <NavLink to="/giftwall" className={({ isActive }) => `group mt-auto w-16 h-16 bg-moBrown border border-moBlack rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? "bg-moCream border border-moBlack text-[#3d5a10] shadow-sm" : "hover:bg-[#FFFFFF] hover:scale-110 hover:-translate-y-1 text-gray-400 hover:text-moBrown"}`}><Icon name="star" size={24} color="currentColor" /></NavLink>
